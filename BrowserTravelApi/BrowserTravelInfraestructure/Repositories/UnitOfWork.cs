...
namespace BrowserTravelInfraestructure.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        private Hashtable _repositories;
        private readonly BrowserTravelCoreApiDbContext _context;


        public UnitOfWork(BrowserTravelCoreApiDbContext context)
        {
            _context = context;
        }

        public BrowserTravelCoreApiDbContext DbContext => _context;
